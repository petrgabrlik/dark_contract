...
def main(limit_l, limit_h, step, rep):
    ...
    print('Interval {},{}, step {}, repetitions {}'.format(limit_l, limit_h, step, rep))
...
if __name__ == '__main__':
    ...
    parser.add_argument('limit_l', type=float, help='Lower interval limit, a required float argument')
    parser.add_argument('limit_h', type=float, help='Upper interval limit, a required float argument')
    parser.add_argument('step', type=float, help='Iteration step, a required float argument')
    parser.add_argument('rep', type=int, help='The number of repetitions, a required integer argument')
    # Parse
